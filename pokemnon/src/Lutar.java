...
public class Lutar {
    ...
    public void lutarPokemon(Pokemon pokemon,Treinador t1){
        ...
        int hpinicial = poke.getInicialhpAtual(t1);
        ...
        switch (op) {
            ...
            while(true){
                ...
                if (poke.getInicialhpAtual(t1) <= 0) {
